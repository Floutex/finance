  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div className="relative flex h-full items-end md:items-center justify-center p-0 md:p-4">
        <div
          className="w-full md:max-w-5xl max-h-[95vh] md:max-h-[90vh] overflow-hidden rounded-t-2xl md:rounded-lg border border-border bg-card shadow-lg outline-none flex flex-col"
          role="dialog" aria-modal="true" aria-labelledby="audit-title"
        >
          <div className="flex items-center justify-between border-b border-border/60 px-6 py-4">
            <p id="audit-title" className="text-lg font-semibold">Logs de auditoria</p>
